...
public class    LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        ...
        // For reference check the method getForTests() method from LabRequestController clas
        try {
        ...
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"Unable to process the request"); // replace this line with your code
        }
