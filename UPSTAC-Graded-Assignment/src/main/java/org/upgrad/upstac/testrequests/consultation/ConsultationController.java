...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,"Unable to process the request");
        }
    ...
    public List<TestRequest> getForDoctor() {
        ...
        {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Unable to process request");
        }
    }
